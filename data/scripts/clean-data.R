...
clean_data_from_raw <- function(dt){
  ...
  col_unrelevant <- c("winner_id", "winner_name", "loser_id", "loser_name", "winner_entry", "loser_entry", "winner_ioc", "loser_ioc", "winner_hand", "loser_hand", "winner_rank", "winner_rank_points", "loser_rank_points", "loser_rank", "winner_age", "loser_age", "winner_ht", "loser_ht")
