...
\resizebox{\linewidth}{!}{\begin{tabular}[t]{lclcl}
		...
		\midrule
		\showrowcolors
		Réseau de neurones & 0.7843 & 0.8382 & 0.7890 & 0.8418\\
		Ensemble & 0.7614 & 0.8210 & 0.7614 & 0.8210\\
		Multinomial & 0.7614 & 0.8210 & 0.7614 & 0.8210\\
		LDA & 0.7571 & 0.8178 & 0.7571 & 0.8178\\
		Forêt aléatoire & 0.7555 & 0.8166 & 0.7526 & 0.8144\\
		\addlinespace
		Arbre de décision & 0.7553 & 0.8165 & 0.7560 & 0.8170\\
		Bayes & 0.7465 & 0.8099 & 0.7465 & 0.8099\\
		QDA & 0.7224 & 0.7918 & 0.7224 & 0.7918\\
		Bayes & 0.7114 & 0.7836 & 0.7114 & 0.7836\\
		SVM Gaussien & 0.7018 & 0.7763 & 0.7018 & 0.7763\\
		\bottomrule
\end{tabular}}
