...
\begin{enumerate}
  \item le classifieur de naïf de Bayes \cite{packagee1071}
  \item le classifieur régression logistique \cite{packagennet} 
  \item l'analyse discriminante linéaire \cite{packageMASS}
  \item l'analyse discriminante quadratique  \cite{packageMASS}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item le classifieur par forêt aléatoire \cite{packagerandomForest}
  \item le classifieur SVM \cite{packagee1071}
\end{enumerate}
...
\begin{enumerate}
  \item les réseaux de neuronnes \cite{packagekeras}
  \item le modèle par ensemble 
\end{enumerate}
